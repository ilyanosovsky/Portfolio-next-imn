import { courtImg, threadsImg, orderEatsImg } from "@/public/assets";
        ...
        <div className="flex flex-col xl:flex-row gap-6 w-full">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              Order Eats is a{" "}
              <span className="text-textGreen">food-ordering platform</span>{" "}
              that provides users with a seamless and enjoyable experience. The
              app includes features like user authentication, restaurant
              management, cart operations, real-time order tracking, and more.
