    ...
    >
      ...
      <div className="flex flex-col lgl:flex-row gap-16">
        ...
        <div className="w-full lgl:w-1/3 h-80 relative group">
          ...
          <div className="lgl:inline-flex w-full h-80 border-2 border-textGreen rounded-md group-hover:-translate-x-2 group-hover:-translate-y-2 transition-transform duration-300"></div>
        </div>
      </div>
    </section>
  );
